...
# Building Performance Dashboard - Server Startup Script with Virtual Environment
echo "🚀 Starting Building Performance Dashboard Servers (Virtual Environment)..."
...
if check_port 8000; then
    ...
    BACKEND_PID=$!
    cd ..
    echo "✅ Python Backend started with PID: $BACKEND_PID (Virtual Environment)"
fi
